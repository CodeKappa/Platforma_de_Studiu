...
public class PanelAdminCRUDuser extends JPanel {
	...
	public PanelAdminCRUDuser() {
		...
		radio_profesor.setBounds(988, 354, 78, 21);
		add(radio_profesor);
	...
	public void setActionListeners()
	{
		...
		button_create.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try 
				{
					AdminSqlQueries.admin_create_user(MainClass.db.getCon(), getData());
		...
		button_update.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try 
				{
					AdminSqlQueries.admin_update_user(MainClass.db.getCon(), getData());
					setTable(AdminSqlQueries.all_user_data(MainClass.db.getCon()));
				} 
				catch (SQLException e1) { TreatException.printSQLException(e1); }
			}
		...
		button_delete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try 
				{
					AdminSqlQueries.admin_delete_user(MainClass.db.getCon(), textField_cnp.getText());
					setTable(AdminSqlQueries.all_user_data(MainClass.db.getCon()));
				} 
				catch (SQLException e1) { TreatException.printSQLException(e1); }
			}
	...
	public void setData(ArrayList<String> arr)
	{
		...
		else
		{
			...
			if(arr.get(arr.size()-1).equals("2"))
			{
